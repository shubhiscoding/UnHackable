                ...
                <div className="flex min-h-screen bg-[rgb(50,51,50)]">
                    ...
                    <div className="flex-col h-full w-full">
                        ...
                        {title == "Generate Wallet" || title == "Recover Wallet" ? 
                            (<div className="flex-col h-full p-6 w-full space-y-3 max-md:p-2 max-md:mt-20">
                                ...
                                <div className="flex max-md:flex-col justify-evenly px-5 gap-5 w-full max-md:px-0">
                                    ...
                                    {window.innerWidth > 768 && <BalanceCard walletAddress={publicKey} walletName={walletName} createdAt={createdAt}/>}
                                </div>
                            </div>):<></>
                        }
                        {
                            title == "My Wallets" ?(
                                <div className="flex h-min p-6 justify-evenly gap-5 max-md:flex-col max-md:mt-16 max-md:px-2">
                                    <SavedHints title={title} Hint={wallets} publicKey={publicKey} setPublicKey={setPublicKey}/>
                        ...
                        {
                            title == "Protfolio" ?(
                                <div className="flex h-min p-6 justify-evenly gap-5 max-md:mt-16">
                        ...
                        }
                        {
                            title == "Support UnHackable" ?(
                                <div className="flex w-full p-4 md:p-6 justify-center max-md:mt-20">
